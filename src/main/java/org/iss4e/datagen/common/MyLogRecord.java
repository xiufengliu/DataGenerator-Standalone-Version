...
public class MyLogRecord extends LogRecord {
   ...
   */
  public static final String[] IGNORE_CLASSES = { Logger.class.getCanonicalName(), Logging.class.getCanonicalName(),  MyLogRecord.class.getCanonicalName()  };
   ...
   */
  public MyLogRecord(Level level, CharSequence msg) {
